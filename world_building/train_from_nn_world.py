    ...
    for i in range(int(args['max_episodes'])):
        ...
        for j in range(int(args['max_episode_len'])):
            ...
            if terminal:
                ...
                print('| Reward: {:d} |  Avg Reward: {:d} | Episode: {:d} | Qmax: {:.4f}'.format(int(ep_reward), int(ep_rewards_avg), i, (ep_ave_max_q / float(j))))
                break
...
def main(args):
    with tf.Session() as sess:
        ...
        action_bound = np.array([1.0]) #env.action_space.high
        ...
        world_model = load_model(args['world_model'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--restore', help='restore from saved model', action='store_true')
    parser.add_argument('--world-model', help='restore from saved world model')
